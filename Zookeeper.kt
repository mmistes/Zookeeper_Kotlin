...
const val stringInp = "Please enter the number of the habitat you would like to view: "
const val stringExit = "exit"
const val stringGoodBye = "See you later!"
...
fun main() {
    ...
    while (true) {
        ...
        if (inp == stringExit) {
            println(stringGoodBye)
            break
        } else {
            if (inp.toInt() in 0..5) {
                println(animals[inp.toInt()] + "\n" + stringInp)
            } else {
                println("Number is not valid. Please enter a number from 0 to 5. And press Enter.")
            }
        }
    }
}
